...
const links = [
  ...
  { href: "/ratings", label: "Rankingi", icon: Trophy },
  { href: "/backtest", label: "Backtest", icon: FlaskConical },
  { href: "/scanner", label: "Skaner", icon: Search },
  { href: "/recommendations", label: "Centrum dnia", icon: Sparkles },
  { href: "/play-plan", label: "Plan gry", icon: ClipboardList },
  { href: "/strategies", label: "Strategie", icon: ListChecks },
  { href: "/portfolio", label: "Portfel", icon: WalletCards },
  { href: "/monitoring", label: "Nadzór", icon: Radar },
