              ...
              {workshop ? (
                <>
                  ...
                  {workshop.lineRecommendation ? (
                    <div className="flex flex-wrap items-center justify-between gap-4 rounded-lg border border-emerald-200 bg-emerald-50 p-4 dark:border-emerald-900 dark:bg-emerald-950/30">
                      <div>
                        <div className="text-xs font-medium uppercase text-emerald-700 dark:text-emerald-300">
                          Linia najbliższa 50/50
                        </div>
                        <div className="mt-1 text-2xl font-semibold">
                          {workshop.lineRecommendation.line}
                        </div>
                        <div className="mt-1 text-sm text-zinc-600 dark:text-zinc-300">
                          Over {percent(workshop.lineRecommendation.overProbability)}
                          {" · fair "}
                          {formatNumber(workshop.lineRecommendation.overFairOdds, 2)}
                          {" · "}
                          Under {percent(workshop.lineRecommendation.underProbability)}
                          {" · fair "}
                          {formatNumber(workshop.lineRecommendation.underFairOdds, 2)}
                        </div>
                        <div className="mt-1 text-xs text-zinc-500">
                          Odchylenie od idealnego balansu:{" "}
                          {formatNumber(workshop.lineRecommendation.balanceGap, 1)} pp.
                          To wynik rozkładu empirycznego, nie gwarancja.
                        </div>
                      </div>
                      {recommendedLineHref ? (
                        <Link
                    ...
                    <div className="rounded-lg border border-amber-200 bg-amber-50 p-3 text-sm text-amber-800 dark:border-amber-900 dark:bg-amber-950/30 dark:text-amber-300">
                      Za mało danych, aby zaproponować linię najbliższą 50/50.
                    </div>
                  )}
